...
// Create route to get all master records in one json.
router.route('/getmasterrec')  
  .get(authController.isAuthenticated, masterController.getMasterListJson);
  
router.route('/getfreshmasterrec')  
  .get(authController.isAuthenticated, masterController.refreshMasterListJson);
